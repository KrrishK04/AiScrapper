...
class Click(BaseModel):
    """Performs a click on a web element. The description should be a human-readable description of the element being clicked."""
...
class FillField(BaseModel):
    """Fills an input field with specified text. The description should be a human-readable description of the field being filled."""
...
class SelectDropdown(BaseModel):
    """Selects an option from a dropdown menu. The description should be a human-readable description of the selection being made."""
...
class PerformPostback(BaseModel):
    ...
    The description should be a human-readable description of the postback action.
    """
...
class ExtractData(BaseModel):
    ...
    The description should be a human-readable confirmation.
    """
...
class Finish(BaseModel):
    ...
    The reason should be a human-readable explanation.
    """
